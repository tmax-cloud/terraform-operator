...
// +kubebuilder:rbac:groups=terraform.tmax.io,resources=storages,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=terraform.tmax.io,resources=storages/status,verbs=get;update;patch
